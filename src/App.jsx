...
const searchData = movie.data.filter((item)=>{
  ...
  <div className="container">
   ...
   <div className="navbar">
    ...
    <div className="search">
      <input type="text" placeholder="Search anime or movie" value={search} onChange={(e)=>setSearch(e.target.value)}/>
    </div>
   </div>
   ...
   <div className="explore">
    ...
    <div>
        {
            searchData.length > 0 ? searchData.map((a)=>{return (<img key={a.id} img={a.image}/>)}) : <h1>No data</h1>
        }
    </div>
    <div className="description">
        <h1>Weathering with you</h1>
        <p>sdfoje</p>
    <img src='/spy_carousel 1.png' alt="spy"/>
   ...
   <div>
    <h1>New Release</h1>
    <div className="film">
    <img src='/Group 5.png' alt="op"/>
    <img src='/Group 4.png' alt="boruto" style={{height:'306px'}}/>
    <img src='/Group 2.png' alt="spyx" />
    <img src='/card_movie.png' alt="titan" style={{height:'306px'}}/>
    <img src='/card_movie (1).png' alt="tsu" style={{height:'306px'}}/>
    <img src='/card_movie (2).png' alt="aoashi"/>
    </div>
   </div>
  </div>
</>
